...
#### Project: A Systems Thinking Approach Toward Sustainable Product Design
...
Summary: The emergence of new technological advancements increases the complexity level of systems, such as those in aerospace, resulting in unpredictable behaviors. Systems engineering practices have extensively used systems thinking to conceptualize the problem domain and reveal the underlying patterns in complex systems. Tools such as causal loop diagrams (CLD) and quantitative techniques such as stock and flow models are implemented to identify reinforcing and balancing loops within a system. One of the main challenges in implementing systems thinking approaches is the subjective aspects of it, in variable identification and causal relationships between them. This research aims to utilize natural language processing (NLP) and data (reports) about problem domains to systematically identify variables to assist the domain expert in generating holistic solutions for the complex system. An aircraft accident report data is analyzed in this paper to identify the key variables associated with the cascading failures in aerospace systems. Large language models (LLMs), prompt engineering, and topic modeling methods are utilized to provide a detailed understanding of the main variables within these accident reports. The analysis identified the critical variables initiating the failure and development of a CLD. The findings highlight the applications of NLP in systems engineering methods and its contribution to the risk assessment of aerospace systems.
