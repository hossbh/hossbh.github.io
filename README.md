...
- Project: Improving the Assembly Line of Hydraulic Power Steering Systems, 2016
  - Summary: The steering system is considered a critical component in the car, and the quality of the assembled components is essential because any mistake can have significant consequences, mainly for the passengers. Optimization of hydraulic power steering's (HPS) assembly line was a project introduced to reduce the risk factors that can impact the final product quality during assembling processes. By defining the risks and grading them, the most critical risks were selected, and a friction test machine was chosen to be added to the assembly line of the steering system. This machine is responsible for testing the friction of the pinion and rack bar and evaluating if components were assembled in their correct positions. The critical parameters of the friction machine and the user requirement specifications were generated and provided to a manufacturer. The design of this machine required robotic clamping and movements of assembly line pallets. The machine was planted in the assembly line, and the modifications were performed to complete the optimization task. The quality control (QC) department's results showed that the quality increased by more than 20% after the installation of this machine. The figures below show the HPS used for the friction test and the friction test machine installed.
![Friction Test](/assets/img/ftest.png)
